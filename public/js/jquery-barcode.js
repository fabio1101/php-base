...
(function ($) {
  ...
  var barcode = {
    ...
    digitToCssRenderer : function($container, settings, digit, hri, mw, mh){
      ...
      var content = "";
      var full_width = 0;
      var bar0 = "<div style=\"float: left; margin-top:5px; font-size: 0px; background-color: " + settings.bgColor + "; height: " + mh + "px; width: &Wpx\"></div>";    
      var bar1 = "<div style=\"float: left; margin-top:5px; font-size: 0px; width:0; border-left: &Wpx solid " + settings.color + "; height: " + mh + "px;\"></div>";
      ...
      if (settings.showHRI){
        content += "<div style=\"clear:both; width: " + full_width + "px; background-color: " + settings.bgColor + "; color: " + settings.color + "; text-align: left;padding-left: 10px; font-size: " + settings.fontSize + "px; margin-top: " + settings.marginHRI + "px;\">"+hri+"</div>";
      }
      this.resize($container, mw * columns).html('<div style="width: ' + (full_width + 10) + 'px; margin: auto; border: solid 1px gray; border-radius: 5px;">' + content + '</div>');
    },
